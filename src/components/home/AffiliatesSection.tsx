...
// Duplicate for seamless display
  ...
  return (
    <section className="py-16 md:py-24 bg-muted/30 overflow-hidden">
      <div className="w-full px-4 sm:px-8 md:px-16 lg:px-24">
        ...
        {/* Stats Row */}
        <div className="grid grid-cols-3 gap-4 md:flex md:flex-wrap md:justify-center md:gap-16 mb-10 md:mb-16">
          {stats.map((stat) => (
      ...
      <div className="relative">
        ...
        {/* Scrolling Track */}
        <div className="flex gap-4 sm:gap-6 md:gap-12 overflow-hidden">
          <div className="flex gap-4 sm:gap-6 md:gap-12 animate-marquee">
