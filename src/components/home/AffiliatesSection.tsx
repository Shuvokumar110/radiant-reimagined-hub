...
export function AffiliatesSection() {
  ...
  return (
    <section ref={containerRef} className="py-16 md:py-24 bg-muted/30 overflow-hidden">
      <div className="w-full px-4 sm:px-8 md:px-16 lg:px-24">
        ...
        >
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-2 bg-background rounded-full mb-4 md:mb-6"
          >
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="grid grid-cols-3 gap-4 md:flex md:flex-wrap md:justify-center md:gap-16 mb-10 md:mb-16"
        >
          {stats.map((stat, index) => (
            ...
            >
              <motion.span
                ...
                className="text-2xl sm:text-3xl md:text-5xl font-bold text-foreground block"
              >
                {stat.value}
              </motion.span>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="h-px bg-border max-w-2xl mx-auto mb-10 md:mb-16 origin-center"
        />
      </div>
