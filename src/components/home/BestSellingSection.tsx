...
const products = [
  ...
  { id: 2, name: "Pro Jersey - Sunset Orange", category: "Jerseys", slug: "jersey-sunset-orange", image: jerseyOrange },
  { id: 3, name: "Pro Jersey - Forest Green", category: "Jerseys", slug: "jersey-forest-green", image: jerseyGreen },
  { id: 4, name: "Basketball - Flame Edition", category: "Team Uniforms", slug: "basketball-flame", image: basketballFlame },
];
          ...
          {products.map((product) => (
            ...
            >
              <Link to={`/shop/${product.slug}`}>
                {/* Image Container */}
                <div className="relative overflow-hidden rounded-2xl bg-background mb-4 aspect-[3/4] transition-transform duration-300 group-hover:-translate-y-2">
                  <img
                    src={product.image}
                    alt={product.name}
                  ...
                  <div className={`absolute inset-0 bg-black/40 flex items-center justify-center gap-3 transition-opacity duration-300 ${
                    ...
                    {[Heart, Eye, ShoppingBag].map((Icon, i) => (
                      <button
                        key={i}
                        className="w-10 h-10 bg-background text-foreground rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
                      >
